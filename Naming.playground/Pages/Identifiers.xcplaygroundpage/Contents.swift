...
let numberOfPotBelliedPigs = 0 + 1

let numberOfFish = 2000 - 1999

let numberOfSnakes = -3 + 4

let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + numberOfSnakes + numberOfFish + numberOfPotBelliedPigs
