...
let totalTime = brushTeeth + makeLunch + makeBreakfast + shower + getDressed + gatherThings
...
let haveToDo = brushTeeth + shower + getDressed + gatherThings
let wantToDo = makeBreakfast + makeLunch
let dontWantToDo = washDishes
/*:
...
*/
let timeMaximum = 30
let timeLeftover = timeMaximum - haveToDo
// To fit another 25 minutes of activities to do, I need to wake up 25-30 minutes earlier
